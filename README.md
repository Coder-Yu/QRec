...
<div>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>Main option: -testSet, -ap, -cv, -val </br>
      ...
      -val ratio (model test would be conducted on the validation set which is generated by randomly sampling the training dataset with the given ratio.)</br> 
      Secondary option:-b, -p, -cold, -tf</br>
      -b thres （binarizing the rating values. Ratings equal or greater than thres will be changed into 1, and ratings lower than val will be changed into 0. e.g. -b 3.0）</br>
